...
{
    enum Enemy2State { Disabled = 0, Active, Explosion }
    ...
    class EnemyType2
    {
        ...
        public EnemyType2(Texture2D texture, Texture2D texExplo, Texture2D texShot, Texture2D barlife01, Texture2D barlife02, Texture2D barenemy)
        {
            this.texture = texture;
            position = new Vector2(100, SpaceGame.SCREEN_HEIGHT);
