...
namespace SpaceShooter
{
    class EndingScreen2
    {
        ...
        public EndingScreen2(ContentManager content)
        {
            background = content.Load<Texture2D>("graphics/backEndingLose");
            ...
            //SpaceGame.SCREEN_WIDTH / 2 - 350, SpaceGame.SCREEN_HEIGHT / 2 - 100
        }
        ...
        public void Update(InputManager input)
        {
            ...
            if (fade <= 0.0f)
            {
                ...
                if (position.X <= SpaceGame.SCREEN_WIDTH / 2 - 350)
                {
                    position.X = SpaceGame.SCREEN_WIDTH / 2 - 350;
                }
            }
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(font01, "YOU LOSE!", position, Color.White);
